...
class ValidationResult:
    ...
    @staticmethod
    def invalid(error: str, field: str | None = None) -> "ValidationResult":
...
def validate_voice(voice: str | None) -> ValidationResult:
    """
...
def validate_style(style: str | None, voice: str | None = None) -> ValidationResult:
    """
...
def validate_preset(preset: str | None) -> ValidationResult:
    """
...
def validate_filename_title(title: str | None) -> ValidationResult:
    """
...
def validate_synthesis_id(synthesis_id: str | None) -> ValidationResult:
    """
